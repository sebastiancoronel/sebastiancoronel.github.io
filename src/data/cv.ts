...
export const cvEs: CVData = {
  ...
  contacts: [
    { text: "LinkedIn", link: "https://www.linkedin.com/in/sebastian-alejandro-coronel/" },
    { text: "sebastiancoronel.work@gmail.com", link: "mailto:sebastiancoronel.work@gmail.com" }
  ],
  ...
  skills: [
    {
      title: "Front-end",
      description: "Construcción de dashboards de Fintech, marketplaces de Proptech y mapas interactivos de alto rendimiento con foco en interfaces pixel-perfect y optimización.",
      items: ["React", "TypeScript", "Shadcn", "Tailwind"]
    },
    {
      title: "Back-end",
      description: "Desarrollo de backends transaccionales de alta frecuencia, APIs escalables, integraciones de pasarelas de pago y pipelines de web-scraping estables.",
      items: ["PHP", "Laravel", "Node", "Nest", "PostgreSQL", "MySQL", "REST", "GraphQL", "Python"]
    },
    {
      title: "Arquitectura",
      description: "Aplicación de patrones y refactorización orientada a la mantenibilidad, reduciendo hasta un 20% el esfuerzo de mantenimiento con código estructurado.",
      items: ["SOLID"]
    },
    {
      title: "DevOps / Herramientas",
      description: "Uso de entornos locales dockerizados y herramientas avanzadas para optimizar y asegurar flujos de desarrollo reproducibles.",
      items: ["DDEV"]
    }
  ],
  education: [
...
export const cvEn: CVData = {
  ...
  skills: [
    {
      title: "Front-end",
      description: "Building Fintech dashboards, Proptech marketplaces, and high-performance interactive maps with a focus on pixel-perfect UI and performance optimization.",
      items: ["React", "TypeScript", "Shadcn", "Tailwind"]
    },
    {
      title: "Back-end",
      description: "Development of high-frequency transactional backends, scalable APIs, payment gateway integrations, and stable web-scraping data pipelines.",
      items: ["PHP", "Laravel", "Node", "Nest", "PostgreSQL", "MySQL", "REST", "GraphQL", "Python"]
    },
    {
      title: "Architecture",
      description: "Applying design patterns and maintenance-oriented refactoring, reducing maintenance effort by up to 20% with structured code.",
      items: ["SOLID"]
    },
    {
      title: "DevOps / Tools",
      description: "Using dockerized local environments and advanced tooling to optimize and ensure reproducible development workflows.",
      items: ["DDEV"]
    }
  ],
  education: [
